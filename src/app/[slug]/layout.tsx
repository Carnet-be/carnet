      ...
      <div className="min-h-screen">
        ...
        <div className="relative mx-auto flex max-w-[1100px] flex-col">
          ...
          <div className="w-full -translate-y-[60px] space-y-3">
            ...
            <p className="whitespace-pre-line max-w-[600px]">{garage.about}</p>

            <div className="bg-white/80 p-4 max-w-[500px] rounded-md space-y-1">
              <div className="flex items-center space-x-2">
                <MdEmail className="text-primary" />
                <span className="text-sm text-gray-500">{garage.contact?.email ?? "---"} {garage.contact?.email2 && ` / ${garage.contact?.email2}`}</span>
              </div>
              <div className="flex items-center space-x-2">
                <MdPhone className="text-primary" />
                <span className="text-sm text-gray-500">{garage.contact?.phone ?? "---"} {garage.contact?.phone2 && ` / ${garage.contact?.phone2}`}</span>
              </div>
              <div className="flex items-center space-x-2">
                <MdMap className="text-primary" />
                <span className="text-sm text-gray-500">{garage.contact?.address}</span>
              </div>
            </div>
